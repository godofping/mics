              ...
              <div class="row">
                <div class="col s12 m12 12">
                  ...
                  $result2 = mysqli_fetch_assoc($qry2);
                   ?>
                    <h4 class="header">Edit "<?php echo $result2['NameOfCategory'] ?>" Category Form</h4>
                    <div class="row">
                      <form method="POST" action="update-category.php" class="col s12">
                      
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="NameOfCategory" name="NameOfCategory" value="<?php echo $result2['NameOfCategory'] ?>" type="text">
                            <label for="NameOfCategory">Category</label>
                          </div>
                        </div>

                        <input type="text" name="CategoryId" value="<?php echo $_GET['CategoryId'] ?>" hidden>
