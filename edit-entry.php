    ...
    <div id="main">
        ...
        <div class="wrapper">
            ...
            <section id="content">
                ...
                $qry3 = mysqli_query($connection,"select * from addformtable where AddFormId = '" . $_GET['AddFormId'] . "'"); 
              ...
              <div class="row">
                <div class="col s12 m12 12">
                    ...
                    <h4 class="header">Edit Entry Form</h4>
                    <div class="row">
                      <form enctype="multipart/form-data" method="POST" action="update-entry.php" class="col s12">
                        <div class="row">
                    ...
                    <input class="file-path validate" type="text">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="EntryTitle" name="EntryTitle" value="<?php echo $result3['EntryTitle']; ?>" type="text">
                            <label for="EntryTitle">Entry Title</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="EntryDescription" name="EntryDescription" value="<?php echo $result3['EntryDescription']; ?>" type="text">
                            <label for="EntryDescription">Entry Description</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <textarea id="Resolution" name="Resolution"  class="materialize-textarea"><?php echo $result3['Resolution']; ?></textarea>
                        ...
                        <input type="text" name="ImagePath" hidden value="<?php echo $result3['ImagePath'] ?>">
                        <input type="text" name="AddFormId" hidden value="<?php echo $_GET['AddFormId'] ?>">
