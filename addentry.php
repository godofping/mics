               ...
               <div class="file-field input-field col s12">
                ...
                <div class="file-path-wrapper">
                    <input class="file-path validate" type="text">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="EntryDescription" name="EntryDescription" type="text">
                            <label for="EntryDescription">Entry Description</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <textarea id="Resolution" name="Resolution" class="materialize-textarea"></textarea>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                                ...
                                <div style="text-align: right;">
                                    <button type="submit" class="btn-flat waves-effect pink accent-2 white-text">Add Entry</button>
                                </div>
