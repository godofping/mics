              ...
              <div class="row">
                ...
                <div class="col s12 m12 20">
                  <table>
                    ...
                    <tbody>
                      <?php 
                      $qry3 = mysqli_query($connection,"select * from view_subcategory where CategoryId = '" . $_GET['CategoryId'] . "' AND activate = 1");
                      while ($result3 = mysqli_fetch_assoc($qry3)) { ?>
                      <tr>
                 
                        <td><?php echo $result3['NameOfSubCategory']; ?></td>
                        <td><a href="edit-subcategory.php?CategoryId=<?php echo $result3['CategoryId'] ?>&SubCategoryId=<?php echo $result3['SubCategoryId']; ?>" class="btn-flat waves-effect white accent-2 blue-text">Edit</a> <a href="delete-subcategory.php?CategoryId=<?php echo $result3['CategoryId'] ?>&SubCategoryId=<?php echo $result3['SubCategoryId'] ?>" onclick="return confirm('Are you sure you want to delete this item?');"  class="btn-flat waves-effect white accent-2 blue-text">Delete</a></td>
