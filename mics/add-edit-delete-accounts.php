...
<?php //$qry4 = mysqli_query($connection,"select * from addaccounttable where userlevel = 2 AND active = 1");?>
<?php if ($result3["active"] == 1) {?>
<td>
    <a href="edit-account.php?AddAccountId=<?php echo $result3['AddAccountId'] ?>&from=accountlist" class="btn-flat waves-effect white accent-2 blue-text">Edit</a> <a href="change-password.php?AddAccountId=<?php echo $result3['AddAccountId'] ?>&from=editaccount" class="btn-flat waves-effect white accent-2 blue-text">Change Password</a> <a href="delete-account.php?AddAccountId=<?php echo $result3['AddAccountId']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn-flat waves-effect white accent-2 blue-text">Delete</a> <!--<a href="activate-account.php?AddAccountId=<?php echo $result3['AddAccountId']; ?>" onclick="return confirm('Are you sure you want to activate this item?');" class="btn-flat disabled">activate</a>-->
      </td>
<?php }

else {?>
<td>
    <a href="edit-account.php?AddAccountId=<?php echo $result3['AddAccountId'] ?>&from=accountlist" class="btn-flat grey-text" >Edit</a> <a href="change-password.php?AddAccountId=<?php echo $result3['AddAccountId'] ?>&from=editaccount" class="btn-flat grey-text">Change Password</a> <a href="delete-account.php?AddAccountId=<?php echo $result3['AddAccountId']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn-flat grey-text">Delete</a> <a href="activate-account.php?AddAccountId=<?php echo $result3['AddAccountId']; ?>" onclick="return confirm('Are you sure you want to activate this item?');" class="btn-flat waves-effect white accent-2 blue-text">activate</a>
      </td>
