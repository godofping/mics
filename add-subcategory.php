            ...
            <section id="content">
              ...
              <div class="row">
                <div class="col s12 m12 12">
                    ...
                    <h4 class="header">Add Sub-Category Form</h4>
                    <div class="row">
                      <form method="POST" action="insert-subcategory.php" class="col s12">
                      
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="NameOfSubCategory" required name="NameOfSubCategory" type="text">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                                ...
                                <div style="text-align: right;">
                                    <button type="submit" class="btn-flat waves-effect pink accent-2 white-text">Add Sub-Category</button>
                                </div>
