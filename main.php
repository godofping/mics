                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content  green white-text">
                                        ...
                                        $qry2 = mysqli_query($connection,"SELECT COUNT(*) as totalaccounts FROM addaccounttable");
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content purple white-text">
                                        ...
                                        <h4 class="card-stats-number"><?php 
                                        $qry2 = mysqli_query($connection,"SELECT COUNT(*) as totalaccounts FROM categorytable");
                                        $result2 = mysqli_fetch_assoc($qry2);
                                        echo $result2['totalaccounts'];
                                         ?></h4>
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content blue-grey white-text">
                                        ...
                                        <h4 class="card-stats-number"><?php 
                                        $qry2 = mysqli_query($connection,"SELECT COUNT(*) as totalaccounts FROM subcategorytable");
                                        $result2 = mysqli_fetch_assoc($qry2);
                                        echo $result2['totalaccounts'];
                                         ?></h4>
